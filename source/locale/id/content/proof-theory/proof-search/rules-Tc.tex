...
\end{tabular}
\end{center}
\caption{Aturan-aturan \Log{Tc}. Dalam $\TRule{\False}{\lforall}$ dan
$\TRule{\True}{\lexists}$, !!{constant}~$a$ tidak boleh muncul pada
cabang di atasnya, yakni harus baru bagi cabang tersebut.}
\ollabel{tab:Tc}
\end{table}
