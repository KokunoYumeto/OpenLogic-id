...
\multicolumn{2}{c}{$\Gamma \Sequent x:!A$ jika $x:!A \in \Gamma$}\\[3ex]
...
\DisplayProof}
\end{tabular}
\caption{Aturan sistem deduksi alami intuisionistik proposisional berlabel
term \Log{tN3ip} sebagai sistem penetapan tipe.}
\ollabel{tab:tN3ip}
\end{table}
