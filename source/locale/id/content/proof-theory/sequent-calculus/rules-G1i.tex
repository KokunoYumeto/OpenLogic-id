...
\DisplayProof
\end{tabular}
\caption{Aturan-aturan \Log{G1i} untuk logika intuisionistik. Dalam
$\RightR{\forall}$ dan $\LeftR{\exists}$, !!{constant}~$a$ tidak boleh
muncul dalam sekuen kesimpulan. $\Gamma$ merupakan multihimpunan
!!{formula}s, sedangkan $\Delta$ boleh kosong atau memuat satu
!!a{formula}. Tidak ada aturan \RightR{\Contraction}. \Log{G1m} adalah
\Log{G1i} tanpa~\RightR{\Weakening} dan tanpa aksioma $\lfalse,
\Gamma \Sequent \Delta$.}
\ollabel{tab:G1c}
\end{table}
