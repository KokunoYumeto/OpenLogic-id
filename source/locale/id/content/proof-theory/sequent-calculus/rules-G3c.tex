...
\DisplayProof
\end{tabular}
\caption{Aturan-aturan \Log{G3c}. Dalam $\RightR{\forall}$ dan
$\LeftR{\exists}$, !!{constant}~$a$ tidak boleh muncul dalam sekuen
kesimpulan. $\Gamma$~dan $\Delta$ merupakan multihimpunan
!!{formula}s. Dalam aksioma, !!{formula}~$!C$ harus atomik.}
\ollabel{tab:G3c}
\end{table}
