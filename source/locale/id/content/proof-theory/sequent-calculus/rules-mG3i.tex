...
\DisplayProof
\end{tabular}
\caption{Aturan-aturan \Log{mG3i} berkesimpulan jamak untuk logika
intuisionistik. Dalam $\RightR{\forall}$ dan $\LeftR{\exists}$,
!!{constant}~$a$ tidak boleh muncul dalam sekuen kesimpulan.
$\Gamma$~dan $\Delta$ merupakan multihimpunan !!{formula}s. Dalam
aksioma, !!{formula}~$!C$ harus atomik. \Log{mG1m} adalah
\Log{mG1i} tanpa aksioma $\lfalse,
\Gamma \Sequent \Delta$.}
\ollabel{tab:G3c}
\end{table}
