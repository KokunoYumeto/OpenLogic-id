...
\DisplayProof
\end{tabular}
\caption{Aturan-aturan \Log{G3i} untuk logika intuisionistik. Dalam
...
!!a{formula}. Dalam aksioma, !!{formula}~$!C$ harus atomik.
\Log{G1m} adalah \Log{G1i} tanpa aksioma $\lfalse, \Gamma \Sequent
\Delta$.}
\ollabel{tab:G3c}
\end{table}
