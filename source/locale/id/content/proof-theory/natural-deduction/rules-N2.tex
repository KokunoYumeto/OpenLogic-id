...
\DisplayProof
\end{tabular}
\caption{Aturan-aturan \Log{N2c} dan \Log{N2i}. Dalam
$\Intro{\lforall}$ dan $\Elim{\lexists}$, !!{constant}~$a$ tidak boleh
muncul dalam sekuen kesimpulan. $\Gamma_i$ adalah himpunan !!{formula}
berlabel~$x:!A$. Aturan \Intro{\lforall} dan \Elim{\lexists} harus
memenuhi syarat variabel eigen: $a$ tidak boleh muncul dalam sekuen
kesimpulan. \Log{N2i} tidak memuat \FalseCl.}
\ollabel{tab:N2}
\end{table}
