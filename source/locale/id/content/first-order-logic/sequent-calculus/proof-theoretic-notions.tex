...
\begin{editorial}
  Bagian ini menghimpun definisi relasi keterbuktian dan konsistensi
  untuk kalkulus sekuen.
\end{editorial}

\iftag{FOL}
      {\olfileid[id]{fol}{seq}{ptn}}
      {\olfileid[id]{pl}{seq}{ptn}}
...
\begin{prob}
Buktikan \olref[fol][seq][ptn]{prop:incons}.
\end{prob}
