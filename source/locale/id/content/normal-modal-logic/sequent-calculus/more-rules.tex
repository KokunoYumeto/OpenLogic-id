...
\olfileid[id]{nml}{seq}{mru}

\olsection{Aturan bagi Relasi Aksesibilitas Lain}

Untuk menangani logika yang ditentukan oleh relasi aksesibilitas khusus, kita
mempertimbangkan aturan tambahan dalam \olref{tab:more-rules}.
...
Penambahan aturan-aturan ini menghasilkan sistem yang sahih dan lengkap bagi
logika yang diberikan dalam \olref{tab:logics-rules}.
...
\begin{table}
  \begin{center}
    ...
    \end{tabular}
  \end{center}
  \caption{Aturan sekuen bagi berbagai logika modal.}
  \ollabel{tab:logics-rules}
\end{table}

\iftag{prvBox}{
\begin{ex}
  Kita memberikan !!a{derivation} sekuen yang menunjukkan
  $\Log{K4}\Proves\Ax{4}$, yakni $\Box!A\lif\Box\Box!A$.
  \begin{prooftree}
...
\begin{ex}
  Kita memberikan !!a{derivation} sekuen yang menunjukkan
  $\Log{K4}\Proves\Ax{4}$, yakni $\Diamond\Diamond!A\lif\Diamond!A$.
  \begin{prooftree}
...
\begin{ex}
  Kita memberikan !!a{derivation} sekuen yang menunjukkan
  $\Log{S5}\Proves\Ax{5}$, yakni $\Diamond!A\lif\Box\Diamond!A$.
  \begin{prooftree}
    \Axiom$\Diamond!A \fCenter \Diamond!A$
    \RightLabel{5$\Box$}
...
\begin{ex}
Kalkulus sekuen bagi~\Log{S5} tidak lengkap tanpa aturan~\Cut{}; misalnya,
\iftag{prvBox}{$\Diamond\Box !A\lif !A$}{$!A\lif\Box\Diamond !A$}, yang
valid dalam~$\Log{S5}$, tidak mempunyai pembuktian tanpa~\Cut. Berikut
!!a{derivation} yang menggunakan~\Cut:
\begin{prooftree}
...
\begin{prob}
Berikan !!{derivation}s sekuen yang menunjukkan hal-hal berikut:
  \begin{enumerate}
