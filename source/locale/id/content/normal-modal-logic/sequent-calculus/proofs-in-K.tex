...
\olfileid[id]{nml}{seq}{prk}

\olsection{\usetoken{P}{derivation} Sekuen bagi \Log{K}}

\iftag{prvBox}{

\begin{ex}
  Kita memberikan !!a{derivation} kalkulus sekuen yang menunjukkan
...
\iftag{notprvBox,notprvDiamond}{}{
  Berikut !!a{derivation} dari~\Dual.
  \begin{prooftree}
    \Axiom$!A \fCenter !A$
...
\begin{prob}
  Temukan pembuktian kalkulus sekuen dalam~$\Log{K}$ bagi !!{formula}s
  berikut:
  \begin{enumerate}
